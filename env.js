...
const EXPO_ACCOUNT_OWNER = 'devsherpa'; // expo account owner
const EAS_PROJECT_ID = '38e5ba56-d34d-4bce-a9d9-d5553233f70f'; // eas project id sherpa.personall account
const SCHEME = 'khel'; // app scheme
